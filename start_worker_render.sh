...
exec python worker_render.py \
    ...
    --queues high,hora_nfe,artifacts,atacadao,agent_background,odoo_lancamento,impostos,recebimento,hora_backfill,sped_ecd,inventario,agent_eval,agent_validation,agent_judge,default \
    --verbose
