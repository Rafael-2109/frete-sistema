...
<task type="auto">
  ...
  <action>
COMPLEXITY NOTE: These templates have HIGH combined complexity (46 + 79 = 125 hardcoded colors).
If context pressure is felt during execution, STOP and split cnab400_lote_detalhe.html to a separate plan.
