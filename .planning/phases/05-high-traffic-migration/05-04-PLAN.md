...
```
  ...
  <done>Print templates verified as intentionally excluded, documented in _embarques.css</done>
</task>
...
2. Run: `grep -c "#[0-9a-fA-F]\{3,6\}" app/templates/embarques/imprimir_completo.html`
   Expected: High count (30+) - print templates MUST keep hardcoded colors
