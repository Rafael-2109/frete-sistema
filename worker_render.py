...
@click.option('--queues', default='high,hora_nfe,artifacts,atacadao,odoo_lancamento,impostos,recebimento,hora_backfill,sped_ecd,inventario,agent_validation,default', help='Filas a processar')
