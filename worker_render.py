...
@click.option('--queues', default='high,hora_nfe,artifacts,atacadao,agent_background,odoo_lancamento,impostos,recebimento,hora_backfill,sped_ecd,inventario,agent_validation,agent_judge,default', help='Filas a processar')
