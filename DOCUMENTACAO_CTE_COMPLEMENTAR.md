...
### **3. Vinculação com Despesas Extras** ⚠️ TODO

**Processo Manual (usuário decide):**

1. Usuário acessa tela de **Despesas Extras**
2. Sistema sugere CTes complementares não vinculados
3. Usuário escolhe vincular ou não
4. Similar ao processo atual de vinculação de CTe → Frete

**Arquivos a modificar:**

- `app/fretes/routes.py` - Rota de despesas extras
- `app/templates/fretes/despesas_extras.html` - Interface de sugestão
- `app/fretes/models.py` - Adicionar `cte_id` em `DespesaExtra` (se ainda não existir)
...
- [ ] Integração com Despesas Extras
