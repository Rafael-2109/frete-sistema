...
camada: L2
sot_de: —
hub: .claude/references/ssw/fluxos/INDEX.md
superseded_by: —
...
> **Papel:** INTEGRACOES TRANSVERSAIS.

## Indice

- [Odometro como Eixo Central (F15/F16/F17)](#odometro-como-eixo-central-f15f16f17)
- [CCF como Integrador Financeiro](#ccf-como-integrador-financeiro)
- [SSWBar como Ferramenta Transversal](#sswbar-como-ferramenta-transversal)
- [SSWMobile](#sswmobile)
- [Lancamentos Automaticos Contabeis (Opcao 541)](#lancamentos-automaticos-contabeis-opcao-541)
- [Ocorrencias SSW Padronizadas](#ocorrencias-ssw-padronizadas)
- [Certificado Digital A1](#certificado-digital-a1)
- [Opcao 903 — Parametros Centrais](#opcao-903-parametros-centrais)
- [Hierarquias de Configuracao](#hierarquias-de-configuracao)
  - [Faturamento](#faturamento)
  - [Limites de Credito](#limites-de-credito)
  - [Tabelas de Frete (Prioridade)](#tabelas-de-frete-prioridade)
  - [Contratacao Transferencia](#contratacao-transferencia)
