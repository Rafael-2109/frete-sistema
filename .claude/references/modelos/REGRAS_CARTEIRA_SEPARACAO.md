...
#### 1. setar_falta_pagamento_inicial (BEFORE_INSERT, linhas 226-259)
...
#### 2. atualizar_status_automatico (BEFORE_INSERT + BEFORE_UPDATE, linhas 261-309)
- **Trigger**: Toda insercao e atualizacao
- **Regras**: Ver "Prioridades de Status" acima

#### 3. log_reversao_status (AFTER_UPDATE, linhas 311-341)
...
#### 4. recalcular_totais_embarque (AFTER_UPDATE + AFTER_DELETE, linhas 343-455)
...
Listener: `app/separacao/models.py:343-455` (`recalcular_totais_embarque`) sincroniza automaticamente.
