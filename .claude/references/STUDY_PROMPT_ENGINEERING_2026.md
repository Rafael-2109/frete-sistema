...
- SDK: `claude-agent-sdk==0.2.89` (CLI bundled 2.1.162, bump 2026-06-03 — 0.2.88/0.2.89 cosmeticos: so CLI bundled, zero breaking no SDK Python) + `anthropic==0.98.1` (atualizado em 2026-05-09)
