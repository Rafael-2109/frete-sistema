...
name: operando-ssw
description: >-
  ESCRITA no SSW via Playwright (cadastros, CT-e, CSVs 402/408, fatura 437,
  POP-A10); dry-run obrigatorio na 1a vez. Gatilhos: "cadastre unidade",
  "emitir/cancelar CT-e", "CT-e complementar", "importar CSV 408", "gerar fatura
  SSW", "nova rota", "vincular transportadora". Anti: consultar/navegar SSW ->
  acessando-ssw; cotacao frete Nacom -> cotando-frete.
