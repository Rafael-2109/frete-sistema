...
@click.option('--queues', default='atacadao,artifacts,agent_validation,sped_ecd,high,agent_eval,agent_judge,default', help='Filas a processar (separadas por vírgula)')
