    ...
    with app.app_context():
        ...
        categories_data = [
            ...
            },
            {
                ...
                'descricao': 'Gestão financeira e faturamento',
                'icone': 'fas fa-dollar-sign',
                'ordem': 2
            },
            {
                'nome': 'cadastros',
                'nome_exibicao': 'Cadastros',
                'descricao': 'Dados mestres e configurações',
                'icone': 'fas fa-database',
                'ordem': 3
            },
            {
                'nome': 'consultas',
                'nome_exibicao': 'Consultas',
            ...
            {
                'nome': 'carteira',
                'nome_exibicao': 'Carteira & Estoque',
                'descricao': 'Carteira de pedidos e estoque',
        ...
        for cat_data in categories_data:
            ...
            if not category:
                ...
                db.session.flush()
                print(f"✅ Categoria criada: {cat_data['nome_exibicao']}")
            else:
                print(f"ℹ️ Categoria já existe: {cat_data['nome_exibicao']}")
            categories[cat_data['nome']] = category
