...
PROMPT_FILE="$PROJECT_DIR/.claude/atualizacoes/dominios/dominio-8-improvement-dialogue.md"
...
# concorrente (corromperia o working tree / cruzaria commits). Horarios sao
# distintos (seg 10:00 vs diario 11:03), mas o lock protege se um atrasar.
...
# -----------------------------------------------------------------------------
# 6. Executar D8 com o prompt completo (cwd = worktree, prompt = arvore principal)
# -----------------------------------------------------------------------------
