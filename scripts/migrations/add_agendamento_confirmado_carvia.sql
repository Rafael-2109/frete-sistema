...
-- Data: 2026-03-30
-- Descricao:
--   1. Novo campo boolean em carvia_cotacoes para toggle de confirmacao de agendamento
--   2. VIEW pedidos atualizada para projetar o campo (ao inves de FALSE hardcoded)
-- RISCO: Recria VIEW pedidos (DROP + CREATE). Execucao rapida, sem downtime perceptivel.

-- Passo 1: Adicionar coluna
ALTER TABLE carvia_cotacoes ADD COLUMN IF NOT EXISTS agendamento_confirmado BOOLEAN NOT NULL DEFAULT FALSE;

-- Passo 2: Recriar VIEW com campo real
