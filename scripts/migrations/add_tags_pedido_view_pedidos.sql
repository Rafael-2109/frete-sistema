-- Migration: Adicionar tags_pedido na VIEW pedidos
-- Data: 2026-02-04
-- Descrição: Altera a VIEW pedidos para incluir campo tags_pedido de separacao
...
SELECT
    ...
    -- equipe_vendas via JOIN com carteira_principal
    min(cp.equipe_vendas::text) AS equipe_vendas,
    -- 🆕 tags_pedido diretamente de separacao (sincronizado de CarteiraPrincipal)
