...
def create_app(config_name=None):
    ...
    def handle_csrf_error(error):   # pyright: ignore[reportUnusedFunction]
        ...
        try:
            ...
            logger.warning(
                f"🔒 ERRO CSRF: {error.description} | Rota: {request.path} | "
    ...
    from app.fretes.frota_routes import frota_bp
    ...
    from app.cmdk import cmdk_bp  # ⌘K Command Palette global
    ...
    app.register_blueprint(cmdk_bp)  # ⌘K Command Palette global
