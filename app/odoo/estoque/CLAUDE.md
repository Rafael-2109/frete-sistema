...
**Status:** EM CONSTRUÇÃO (ONDA 0 concluída 2026-05-22; ONDA 0.4 ✅ fechada 2026-05-24 v3 — G019/G020 codificadas no service; **Skill 2 `transferindo-interno-odoo` ✅ MATURADA ARQUITETURALMENTE em 2026-05-25 v12 + ⚠️ bug D-OPS-5 descoberto v14a-ops** — 3 modos atomicos + helper alto-nivel `distribuir_para_indisponivel` com fallback Modo B + flag `--cleanup-pos-bulk`; demanda 158 cods FB PROD 100% efetiva; bug `_listar_quants_origem` L1145+1147 filtra `lot_id != False` (falha para tracking='none') — workaround Skill 1 ×2 validado; **Skill 6 `planejando-pre-etapa-odoo` 🟡 mín viável COMPLETA v9** — 5 modos planejar/propor/listar/aprovar/executar-onda; **Skill 8 `faturando-odoo` ⬜ PLANEJADA + 3 MINERAÇÕES + TESTE REAL 6 CODS PROD v14a-ops** — documento vivo `PLANEJAMENTO_SKILL8_FATURANDO.md` com 24 checkpoints + §7.5 NOVA (5 dificuldades operacionais D-OPS-1..D-OPS-5 descobertas em teste real 51min, 3 NFs SEFAZ autorizadas, 1590.9 un consolidadas em FB/Indisp/MIGRAÇÃO); service-fonte minerado §7.2 D1-D9 (v13); script-fonte 1866 LOC minerado §7.3 D10-D18 (v14a); RecebimentoLfOdooService 4562 LOC minerado §7.4 G-RECLF-1 a G-RECLF-11 (v14a-fix READ-only — **NAO MEXER**); pattern macro **etapa = barreira de sincronização** confirmado + serializa Playwright F5e vs step_23 G-RECLF-9; sub-nuance MICRO ETAPA B (pipeline por picking sleep 5s G022) documentada; **ETAPA F via 3o atomo Skill 5 NOVO `criar_picking_entrada_destino_manual` (C6.5 expandido — Fluxo>>Skills mantido)**; gotchas compensatorio + G014 destacados; R1 INTACTA; 6 decisões resolvidas; 1 decisão ABERTA (paralelismo G-RECLF-1 v17); baseline pytest 393 verdes) | **Atualizado:** 2026-05-25 v14a-ops
