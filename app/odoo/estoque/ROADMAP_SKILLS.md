...
## SKILL 8 — `faturando-odoo`  (SÓ SAÍDA — ÚLTIMO)  🟡 PLANEJADA + 3 MINERAÇÕES + TESTE REAL PROD + SUB-SKILL C5 LIVE (v14b)
...
- **Skills NOVAS criadas pela Skill 8 ate agora:** (1) `auditando-cadastro-fiscal-odoo` ✅ V1 inventario LIVE (v14b — sub-skill C5; ver seção abaixo); (2) **3 atomos NOVOS na Skill 5** ⬜ v15a — `criar_picking_inter_company` + `validar_picking_inter_company` + `criar_picking_entrada_destino_manual` (incorpora fix D-OPS-3).
