        ...
        if sep_existente:
            ...
            if sep_exemplo:
                ...
                nova_sep = Separacao(
                    ...
                    cidade_normalizada=sep_exemplo.cidade_normalizada,
                    uf_normalizada=sep_exemplo.uf_normalizada,
                    codigo_ibge=sep_exemplo.codigo_ibge,
                    data_pedido=sep_exemplo.data_pedido,
                    expedicao=sep_exemplo.expedicao,
                    agendamento=sep_exemplo.agendamento,
                    agendamento_confirmado=sep_exemplo.agendamento_confirmado,
                    protocolo=sep_exemplo.protocolo,
                    pedido_cliente=sep_exemplo.pedido_cliente,
                    tags_pedido=sep_exemplo.tags_pedido,
                    ...
                    cotacao_id=sep_exemplo.cotacao_id,
                    falta_pagamento=sep_exemplo.falta_pagamento,
                    status=status_lote,
                    sincronizado_nf=False,
