...
**LOC**: ~2.3K | **Arquivos**: 4 | **Atualizado**: 13/04/2026
...
app/teams/
  ...
  ├── models.py        # 77 LOC — TeamsTask (lifecycle 6 estados)
  ├── bot_routes.py    # 477 LOC — 5 endpoints + auth HMAC
  └── services.py      # 1,716 LOC — Core: user/session/response/async processing
```
