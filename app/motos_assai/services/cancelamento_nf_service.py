...
from app.motos_assai.models import (
    ...
    AssaiSeparacao, AssaiSeparacaoItem, AssaiCarregamento,
    SEPARACAO_STATUS_FECHADA, SEPARACAO_STATUS_CARREGADA,
    SEPARACAO_STATUS_FATURADA, SEPARACAO_STATUS_EM_SEPARACAO,
    NF_STATUS_BATEU, NF_STATUS_CANCELADA,
    EVENTO_CARREGADA, EVENTO_SEPARADA, EVENTO_DISPONIVEL, EVENTO_FATURADA,
