...
# 2026-05-17: chassi em assai_moto MAS sem AssaiReciboItem conferido em recibo
# Motochefe. Indica: (a) parser PDF da NF extraiu chassi errado, ou
# (b) digitacao errada na conferencia do recibo, ou (c) NF emitida sem chassi
# fisicamente recebido. Resolver via CCe (caso a) ou substituir_chassi (caso b).
DIVERGENCIA_TIPO_CHASSI_FATURADO_SEM_RECIBO = 'CHASSI_FATURADO_SEM_RECIBO'
