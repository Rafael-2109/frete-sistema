...
EVENTO_DEMONSTRACAO = 'DEMONSTRACAO'  # moto cedida para demonstracao (fora de estoque)
...
EVENTOS_VALIDOS = {
    ...
    EVENTO_MOTO_FALTANDO, EVENTO_DEMONSTRACAO,
}
...
EVENTOS_FORA_ESTOQUE = {
    ...
    EVENTO_DEMONSTRACAO,  # moto em demonstracao nao conta como estoque disponivel
}
