...
class DanfePDFParser:
    ...
    def _extrair_veiculos_llm(
        ...
        prompt = (
            ...
            "(10+ chars) após modelo+cor, o PRIMEIRO é SEMPRE o chassi e o "
            "SEGUNDO é SEMPRE o número do motor. Vale INDEPENDENTE do formato "
            "de cada um — podem ser: (a) ambos alfanuméricos, (b) ambos "
            "dígitos puros, (c) 1º numérico + 2º alfanumérico, (d) 1º "
            "alfanumérico + 2º numérico. NUNCA inverta a ordem.\n"
            "- Códigos longos (10+ chars) podem ser chassi OU motor (decide "
            "pela ordem acima), NUNCA modelo. Isso vale para alfanuméricos "
            "como \"LA25860V1000W2087\" e para dígitos puros como "
            "\"172922506731512\".\n"
