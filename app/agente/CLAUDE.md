...
Encapsula o Claude Agent SDK: chat web (SSE) + Teams bot (async); ~51K LOC em 99 arquivos. Para o roteiro de onde achar cada detalhe, ver **Mapa de Navegacao** acima.
