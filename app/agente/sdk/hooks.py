...
def _compose_hook_context(
    *,
    ...
    """
    return (
        resume_fallback + handoff_context + session_context + main_context
...
def build_hooks(
    ...
    async def _user_prompt_submit_hook(
        ...
        try:
            ...
            if session_context or additional_context or tail_context or correction_hint or debug_context or sql_admin_context or resume_fallback_context or skill_hints_context or world_model_context or handoff_context_block:
