...
try:
    from .admin_free_mode import AdminFreeMode
except ImportError:
    AdminFreeMode = None
...
try:
    ...
    ClaudeProjectScanner = None 

try:
    from .claude_development_ai import ClaudeDevelopmentAI
except ImportError:
    ClaudeDevelopmentAI = None


try:
    from .enhanced_claude_integration import EnhancedClaudeIntegration
except ImportError:
    EnhancedClaudeIntegration = None

try:
    from .intelligent_query_analyzer import IntelligentQueryAnalyzer
except ImportError:
    IntelligentQueryAnalyzer = None
