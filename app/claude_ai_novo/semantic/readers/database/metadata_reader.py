"""
📋 METADATA READER - Leitura de Metadados das Tabelas
...
class MetadataReader:
    """
    Leitor de metadados das tabelas do banco.
    ...
    def set_inspector(self, inspector: Inspector) -> None:
        ...
        """
        self.inspector = inspector
        self.tabelas_cache.clear()  # Limpar cache ao trocar inspector
    ...
    def _obter_constraints_tabela(self, nome_tabela: str) -> Dict[str, List[Dict[str, Any]]]:
        """
        Obtém constraints de uma tabela.
    ...
    def obter_tipos_campo_disponiveis(self) -> Dict[str, int]:
        """
        Obtém estatísticas dos tipos de campos disponíveis.
    ...
    def obter_estatisticas_tabelas(self) -> Dict[str, Any]:
        """
        Obtém estatísticas gerais das tabelas.
