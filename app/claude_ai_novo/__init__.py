...
class ClaudeAINovo:
    ...
    def _get_integration_manager(self):
        ...
        if self.integration_manager is None:
            ...
            self.integration_manager = IntegrationManager(
                claude_client=self.claude_client, db_engine=self.db_engine, db_session=self.db_session
            )
    ...
    def process_query_sync(self, query: Optional[str], context: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": str(e), "fallback_response": "Erro no processamento"}
...
async def create_claude_ai_novo(
    claude_client=None, db_engine=None, db_session=None, auto_initialize: bool = True
) -> ClaudeAINovo:
    """
...
def get_claude_ai_instance():
    ...
    if _claude_ai_instance is None:
        try:
            ...
            # Criar instância
            _claude_ai_instance = ClaudeAINovo(claude_client=claude_client, db_engine=db.engine, db_session=db.session)
