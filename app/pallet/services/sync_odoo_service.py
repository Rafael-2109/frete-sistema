...
class PalletSyncService:
    ...
    def __init__(self, odoo_client):
        ...
        Args:
            odoo_client: Cliente XML-RPC do Odoo configurado
        """
                ...
                try:
                    ...
                    if partner_id:
                        partner_data = self.odoo.search_read(
                            'res.partner',
                            [('id', '=', partner_id)],
                            ['l10n_br_cnpj_cpf', 'name', 'company_type']
                        )
                        if partner_data:
                            cnpj_destinatario = partner_data[0].get('l10n_br_cnpj_cpf', '') or ''
            ...
            for linha in linhas:
                try:
                    ...
                    if partner_id:
                        ...
                        if partner_data:
                            cnpj = partner_data[0].get('l10n_br_cnpj_cpf', '') or ''
    ...
    def sincronizar_tudo(self, dias_retroativos=30):
        """
        Sincroniza remessas e vendas de pallet
        ...
        return {
            ...
            'total_novos': resumo_remessas.get('novos', 0) + resumo_vendas.get('novos', 0)
        }
