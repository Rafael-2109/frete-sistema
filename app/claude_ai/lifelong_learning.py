...
class LifelongLearningSystem:
    ...
    def aplicar_conhecimento(self, consulta: str) -> Dict[str, Any]:
        ...
        try:
            ...
            padroes = _get_db_session().execute(
                text("""
            ...
            try:
                ...
                grupos = _get_db_session().execute(
                    text("""
            ...
            mapeamentos = _get_db_session().execute(
                text("""
