...
def init_app(app):
    ...
    # Registrar blueprint da API unificada
    try:
        from .api_unified import permissions_api_unified
        app.register_blueprint(permissions_api_unified)
        logging.info("✅ Permissions unified API registered successfully")
    except ImportError as e:
        import logging
        logging.warning(f"Could not import unified permissions API blueprint: {e}")
