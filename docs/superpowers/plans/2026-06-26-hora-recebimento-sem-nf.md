...
- **Migrations duais** (regra `~/.claude/CLAUDE.md`): par `.sql` idempotente + `.py` espelho. Próxima = `hora_60`.
...
- [Task 1: Migration hora_60](#task-1-migration-hora_60)
...
|---|---|---|
| `scripts/migrations/hora_60_recebimento_sem_nf.{sql,py}` | Criar | coluna `tipo` + tabela `hora_recebimento_esperado` |
...
### Task 1: Migration hora_60

**Files:**
- Create: `scripts/migrations/hora_60_recebimento_sem_nf.sql`
- Create: `scripts/migrations/hora_60_recebimento_sem_nf.py`
...
Run: `source .venv/bin/activate && python scripts/migrations/hora_60_recebimento_sem_nf.py`
Expected: "Migration HORA 57 concluida com sucesso."

- [ ] **Step 4: Commit**

```bash
git add scripts/migrations/hora_60_recebimento_sem_nf.sql scripts/migrations/hora_60_recebimento_sem_nf.py
git commit -m "feat(hora): migration hora_60 — tipo NF provisoria + hora_recebimento_esperado"
```
