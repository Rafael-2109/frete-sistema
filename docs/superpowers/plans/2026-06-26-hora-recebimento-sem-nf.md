...
- **Migrations duais** (regra `~/.claude/CLAUDE.md`): par `.sql` idempotente + `.py` espelho. Próxima = `hora_55`.
...
- [Task 1: Migration hora_55](#task-1-migration-hora_55)
...
|---|---|---|
| `scripts/migrations/hora_55_recebimento_sem_nf.{sql,py}` | Criar | coluna `tipo` + tabela `hora_recebimento_esperado` |
...
### Task 1: Migration hora_55

**Files:**
- Create: `scripts/migrations/hora_55_recebimento_sem_nf.sql`
- Create: `scripts/migrations/hora_55_recebimento_sem_nf.py`
...
Run: `source .venv/bin/activate && python scripts/migrations/hora_55_recebimento_sem_nf.py`
Expected: "Migration HORA 55 concluida com sucesso."

- [ ] **Step 4: Commit**

```bash
git add scripts/migrations/hora_55_recebimento_sem_nf.sql scripts/migrations/hora_55_recebimento_sem_nf.py
git commit -m "feat(hora): migration hora_55 — tipo NF provisoria + hora_recebimento_esperado"
```
