...
- [TagPlus → WhatsApp (Pedido/NF)](2026-06-06-tagplus-notificacao-whatsapp.md) — plano TDD: webhook dedicado → grupo + DM vendedor (resolve via usuarios), PDF DANFE anexado (send_whatsapp + buffer base64), thread async best-effort, model+migration dual, tela histórico/reenvio; 8 tasks
