...
- **CONFIG** — ✅ **APLICADA (2026-06-13)** (`s10_config_emissao.py`, reversível `--revert`): **journal RETIND `id=1083`** (LF sale, `no_payment=True`+conta 26667+tipo_pedido vazio) + **pt98 configurado** (`invoice_move_type='out_invoice'`+`tipo_pedido='venda-industrializacao'`, src/dest terceiros `31093→26489`). Pré-requisito do GATE 1. Detalhe: `ACHADOS §"CONFIG APLICADA"`.
