...
**G0 ✅** (remessa) · **G1 ✅** (SVL entrada LF `D 1150200001 / C 1150100011`, Δ1150100011=0) · **G2 ✅** (material em 31092 via Model B) · **G3 ✅** (MOs 20252+20254 net-zero terceiros; fix G-ENT-10) · **G5b ✅** (op 3252) · **Dreno físico FB ✅** (26489→30720, picking `FB/INT/08128`/322875, 0 SVL — G-DRENO-1). **G5a 🔴 CONVERGE com G4** (sessão 6: **R-UNIF PROVADO** — NF-teste mista postada/excluída: `no_payment=22800` no j1001 **sozinho não baixa** a ATIVA, o FORNECEDORES do serviço absorve a 1902; exige a 1902 em **doc separado**, = a solução do G4). **G4 🔴 BLOQUEADO por desenho** (grounding sessão 5 refutou o plano: NF mista real → j847/venda-industrializacao; 3 opções em `PROPOSTA §4`, Rafael decidiu investigar). **G6/G8/G9 ⬜**. (Detalhe: `ACHADOS §"ACHADO 2026-06-01 (sessão 5)"`.)
