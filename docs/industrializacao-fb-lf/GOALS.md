...
| **G5a** | FB entrada — NF baixa a ATIVA | Entrada de retorno **credita 5101010001** → **Δciclo em 5101010001 (FB) = 0** (baixa = I da remessa) | **config — ❓ amarrado à decisão Contador (Design conta)**: criar journal de entrada com `account_no_payment_id=5101010001` (hoje não existe; os de entrada caem em 5101020001/2 PASSIVA) e rotear a op do 1902 a ele | G0 |
