...
- [PROPOSTA — Config das operações + journals de RETORNO (G4 LF + G5a FB)](./PROPOSTA_CONFIG_RETORNO.md)
- [Industrialização FB↔LF — Índice](./README.md)
- [RUNBOOK — Piloto E2E 4870112 (Industrialização FB↔LF)](./RUNBOOK_PILOTO_4870112.md)
- [SOT — Operações de Industrialização FB↔LF (fonte única)](./SOT_OPERACOES.md)
- [operacao_cadastro_odoo](./operacao_cadastro_odoo.md)
